...
const columns = [
    ...
    { id: 'total_quantity', header: 'Qty Sold', numeric: true, cell: ({ row }) => row.original.total_quantity.toFixed(4) },
    { id: 'total_value', header: 'Sales Value', numeric: true, cell: ({ row }) => row.original.total_value.toFixed(2) },
