...
<template>
    <AppLayout title="Purchase Return Register" :nav-items="navItems">
        <div class="mb-4 flex items-center justify-between">
            <h2 class="text-base font-bold text-text-strong">Purchase Return Register</h2>
        ...
        <Card variant="panel">
            <DataTable :columns="columns" :data="rows" :page-size="25" empty-message="No debit notes in this range" />
