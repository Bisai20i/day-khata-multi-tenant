...
<template>
    <AppLayout title="Aged Receivables" :nav-items="navItems">
        ...
        <Card variant="panel">
            <DataTable :columns="columns" :data="rows" :page-size="25" empty-message="No outstanding credit sales" />
            ...
            <p class="mt-3 text-[11.5px] text-text-faint">
                Only reflects credit sales reduced by sales returns against them. A customer payment
                recorded via a manual journal voucher (rather than a dedicated receive-payment feature,
                which doesn't exist yet) won't reduce the outstanding amount shown here.
            </p>
        </Card>
    </AppLayout>
</template>
