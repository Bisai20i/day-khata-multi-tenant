...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // item_stock_movements rows, so the new NOT NULL column needs a
        ...
        Schema::table('item_stock_movements', function (Blueprint $table) use ($storeId) {
            $table->foreignId('store_id')->after('item_id')->default($storeId)->constrained()->restrictOnDelete();
        });
    }
