...
return new class extends Migration
{
    ...
    {
        Schema::create('capital_sales', function (Blueprint $table) {
            $table->id();
            // Nullable at the DB level: only required for credit/partial
            // settlement, enforced in CapitalSale::post() rather than a DB
            // constraint (mirrors how bank_account_id is conditionally
            // required below).
    ...
    {
        Schema::dropIfExists('capital_sales');
    }
};
